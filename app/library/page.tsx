...
const PEPTIDES = [
  ...
  // Muscle Growth
  { id: '6', name: 'CJC-1295', category: 'muscle-growth', summary: 'Increases growth hormone for muscle and recovery', details: 'CJC-1295 stimulates natural growth hormone production. May help with muscle growth, fat loss, and recovery. Often combined with Ipamorelin.', dosage: '1-2 mg once per week', sideEffects: 'Water retention, tingling, injection site reactions.' },
  { id: '7', name: 'Ipamorelin', category: 'muscle-growth', summary: 'Boosts growth hormone without raising cortisol', details: 'Ipamorelin is a selective growth hormone booster. Research shows it can help with muscle growth and fat loss without affecting stress hormones.', dosage: '200-300 mcg 2-3 times daily', sideEffects: 'Increased hunger, mild water retention, injection site reactions.' },
  ...
  { id: '13', name: 'TB-500', category: 'healing', summary: 'Supports tissue healing and reduces inflammation', details: 'TB-500 is researched for wound healing and tissue regeneration. Studies show potential for healing injuries and improving flexibility.', dosage: '2-2.5 mg twice per week', sideEffects: 'Mild injection site reactions, temporary fatigue.' },
  { id: '14', name: 'KPV', category: 'healing', summary: 'Anti-inflammatory peptide for gut and inflammation', details: 'KPV is an anti-inflammatory tripeptide researched for reducing inflammation, especially in the gut. May help with inflammatory conditions.', dosage: '500-1000 mcg once daily', sideEffects: 'Minimal; well-tolerated in studies.' },
  
  // Cognitive
  { id: '15', name: 'Semax', category: 'cognitive', summary: 'Improves focus, memory, and reduces stress', details: 'Semax is studied for cognitive enhancement and neuroprotection. Research shows improvements in memory, focus, and stress resilience.', dosage: '300-600 mcg intranasal 1-2 times daily', sideEffects: 'Rare: mild restlessness or headache.' },
  { id: '16', name: 'Selank', category: 'cognitive', summary: 'Reduces anxiety and improves mental clarity', details: 'Selank is researched for anxiety reduction and cognitive enhancement. Studies show it may help reduce stress and improve mood without sedation.', dosage: '250-500 mcg intranasal 1-2 times daily', sideEffects: 'Rare: mild irritability or sleep changes.' },
  { id: '17', name: 'Dihexa', category: 'cognitive', summary: 'Cognitive enhancement and brain health', details: 'Dihexa is researched as a potent cognitive enhancer. Studies suggest it may improve memory and brain function (research only).', dosage: '5-10 mg oral daily (research only)', sideEffects: 'Unknown long-term effects; research stage.' },
  { id: '18', name: 'P21', category: 'cognitive', summary: 'BDNF mimetic for brain health and neurogenesis', details: 'P21 is derived from Cerebrolysin and studied for promoting brain health. May support neurogenesis and cognitive function.', dosage: '10-30 mg subcutaneous daily (research only)', sideEffects: 'Minimal; limited human data.' },
  { id: '19', name: 'NSI-189', category: 'cognitive', summary: 'Neurogenesis and depression research', details: 'NSI-189 is studied for stimulating neurogenesis and treating depression. Clinical trials show potential cognitive benefits.', dosage: '40 mg oral 3 times daily (clinical trial protocols)', sideEffects: 'Headache, insomnia (mild in trials).' },
  
  // Anti-Aging
  { id: '20', name: 'Epithalon', category: 'anti-aging', summary: 'Anti-aging peptide, may support longevity', details: 'Epithalon is researched for anti-aging and telomerase activation. Studies suggest it may support healthy aging and sleep quality.', dosage: '5-10 mg daily for 10-20 days, 1-2 cycles per year', sideEffects: 'Rare: mild fatigue or drowsiness.' },
  { id: '21', name: 'GHK-Cu', category: 'anti-aging', summary: 'Copper peptide for skin, hair, and healing', details: 'GHK-Cu is a copper peptide studied for skin regeneration and anti-aging. Research shows it may improve collagen production and skin appearance.', dosage: '1-3 mg subcutaneous daily or apply topically', sideEffects: 'Mild skin irritation when applied topically.' },
  { id: '22', name: 'MOTS-c', category: 'anti-aging', summary: 'Mitochondrial peptide for energy and longevity', details: 'MOTS-c is a mitochondrial peptide researched for metabolic health and longevity. May improve energy production and insulin sensitivity.', dosage: '5-10 mg 2-3 times per week', sideEffects: 'Minimal; injection site reactions.' },
  { id: '23', name: 'Humanin', category: 'anti-aging', summary: 'Mitochondrial peptide for cellular health', details: 'Humanin is a mitochondrial-derived peptide studied for neuroprotection and metabolic health. May support healthy aging.', dosage: '1-5 mg subcutaneous daily (research protocols)', sideEffects: 'Limited human data available.' },
  
  // Immune Support
  { id: '24', name: 'Thymosin Alpha-1', category: 'immune', summary: 'Immune system modulator, FDA-approved', details: 'Thymosin Alpha-1 is FDA-approved for certain immune conditions. Research shows it may enhance immune function and response.', dosage: '1.6 mg 2-3 times per week', sideEffects: 'Injection site reactions, rare allergic responses.' },
  { id: '25', name: 'LL-37', category: 'immune', summary: 'Antimicrobial peptide for immune support', details: 'LL-37 is an antimicrobial peptide researched for fighting infections and supporting immune health.', dosage: '5-10 mg daily (research protocols)', sideEffects: 'Minimal; injection site reactions possible.' },
  
  // Sexual Health
  { id: '26', name: 'PT-141', category: 'sexual-health', summary: 'FDA-approved for sexual health and libido', details: 'PT-141 (Bremelanotide) is FDA-approved for low sexual desire in women. Works through the brain to enhance arousal.', dosage: '1.75 mg as needed, max once per 24 hours', sideEffects: 'Nausea, flushing, headache (usually mild).' },
  { id: '27', name: 'Kisspeptin-10', category: 'sexual-health', summary: 'Reproductive hormone regulation', details: 'Kisspeptin-10 is researched for reproductive health and hormone regulation. May support healthy sexual function.', dosage: 'Research protocols only (limited human data)', sideEffects: 'Unknown; research stage.' },
  
  // Sleep
  { id: '28', name: 'DSIP', category: 'sleep', summary: 'Delta sleep-inducing peptide for better sleep', details: 'DSIP is researched for sleep regulation and stress reduction. May help improve sleep quality and duration.', dosage: '100-300 mcg before bedtime', sideEffects: 'Drowsiness, vivid dreams.' },
  
  // Skin & Hair
  { id: '29', name: 'GHK-Cu (Topical)', category: 'skin-hair', summary: 'Skin rejuvenation and anti-aging', details: 'GHK-Cu applied topically is studied for skin health. May improve collagen, reduce wrinkles, and support hair growth.', dosage: 'Topical application 1-2 times daily', sideEffects: 'Minimal; rare skin sensitivity.' },
  { id: '30', name: 'Melanotan II', category: 'skin-hair', summary: 'Tanning and libido effects', details: 'Melanotan II is researched for skin tanning and sexual enhancement. May darken skin tone and enhance libido.', dosage: '250-500 mcg 2-3 times per week', sideEffects: 'Nausea, flushing, darkening of moles, increased libido.' },
  
  // Additional peptides
  { id: '31', name: 'Sermorelin', category: 'muscle-growth', summary: 'Growth hormone releasing hormone', details: 'Sermorelin stimulates natural growth hormone production. May support muscle growth, fat loss, and recovery.', dosage: '200-500 mcg once daily before bed', sideEffects: 'Injection site reactions, headache, flushing.' },
  { id: '32', name: 'GHRP-2', category: 'muscle-growth', summary: 'Growth hormone peptide for muscle and fat loss', details: 'GHRP-2 is a growth hormone releasing peptide. Research shows effects on muscle growth and body composition.', dosage: '100-300 mcg 2-3 times daily', sideEffects: 'Hunger, water retention, cortisol increase.' },
  { id: '33', name: 'MK-677', category: 'muscle-growth', summary: 'Oral growth hormone booster', details: 'MK-677 (Ibutamoren) is an oral growth hormone secretagogue. Studies show increases in GH and IGF-1 levels.', dosage: '10-25 mg once daily (oral)', sideEffects: 'Increased appetite, water retention, tingling.' },
  { id: '34', name: 'HGH Fragment 176-191', category: 'weight-loss', summary: 'Fat loss fragment without blood sugar effects', details: 'HGH Fragment 176-191 is studied for fat loss. May promote fat burning without affecting blood sugar or insulin.', dosage: '250-500 mcg once daily', sideEffects: 'Minimal; well-tolerated.' },
  { id: '35', name: 'Retatrutide', category: 'weight-loss', summary: 'Triple agonist, next-generation weight loss', details: 'Retatrutide is in Phase 3 clinical trials for weight loss. Works on three pathways (GLP-1/GIP/Glucagon). Shows 24%+ weight loss in trials.', dosage: 'Research protocols: 1-12 mg once weekly', sideEffects: 'Similar to Tirzepatide; nausea, GI effects.' },
  { id: '36', name: '5-Amino-1MQ', category: 'weight-loss', summary: 'NNMT inhibitor for fat loss and metabolism', details: '5-Amino-1MQ is researched for blocking NNMT enzyme to promote fat loss. May improve metabolism and fat burning.', dosage: '50-100 mg once daily (oral or subcutaneous)', sideEffects: 'Minimal reported; research stage.' },
  { id: '37', name: 'Cerebrolysin', category: 'cognitive', summary: 'Neurotrophic peptide complex for brain health', details: 'Cerebrolysin is a neurotrophic peptide mixture. Research shows neuroprotective effects and cognitive improvements.', dosage: '5-30 mL intramuscular 2-3 times weekly', sideEffects: 'Headache, dizziness, injection site pain.' },
  { id: '38', name: 'Noopept', category: 'cognitive', summary: 'Cognitive enhancement and neuroprotection', details: 'Noopept is studied for memory enhancement and neuroprotection. May improve learning and cognitive function.', dosage: '10-30 mg oral 2-3 times daily', sideEffects: 'Headache, irritability, insomnia (rare).' },
  ...
  { id: '40', name: 'Thymalin', category: 'immune', summary: 'Thymus extract for immune regulation', details: 'Thymalin is a thymus peptide extract studied for immune system support and regulation.', dosage: '10-20 mg intramuscular 1-2 times weekly', sideEffects: 'Minimal; injection site reactions.' },
  { id: '41', name: 'Pinealon', category: 'cognitive', summary: 'Pineal gland peptide for brain health', details: 'Pinealon is a bioregulator peptide for the pineal gland. Research suggests benefits for cognitive function and circadian rhythm.', dosage: '10-20 mg daily for 10 days per cycle', sideEffects: 'Minimal reported.' },
  { id: '42', name: 'SS-31', category: 'anti-aging', summary: 'Mitochondrial health and cellular energy', details: 'SS-31 (Elamipretide) is studied for mitochondrial health. May protect cells and improve energy production.', dosage: 'Research protocols only (IV or subcutaneous)', sideEffects: 'Mild; generally well-tolerated in trials.' },
  { id: '43', name: 'Oxytocin', category: 'sexual-health', summary: 'Social bonding and sexual function', details: 'Oxytocin is a natural hormone studied for social bonding, trust, and sexual function. May enhance intimacy and mood.', dosage: '10-40 IU intranasal as needed', sideEffects: 'Rare: uterine contractions, water retention.' },
...
// Peptide of the Day (random daily)
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-6 pt-32 pb-20 max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <div className="text-2xl text-gray-700 min-h-[36px]">
            <TypeWriter 
        ...
        {/* Peptide of the Day */}
        <div className="bg-gradient-to-br from-blue-50 to-white border border-blue-200 rounded-2xl p-6 mb-8 hover:shadow-md transition-shadow">
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              ...
              <Button
                ...
                className="bg-blue-600 text-white hover:bg-blue-700 font-medium px-6 rounded-lg"
              >
                Learn More →
              </Button>
            </div>
        ...
        <div className="mb-6">
          <Input
            ...
            className="w-full bg-white border-2 border-gray-300 text-gray-900 py-4 px-6 rounded-full text-base focus:border-blue-600 focus:ring-2 focus:ring-blue-200"
          />
        </div>
        ...
        {/* Success Message */}
        {showSuccess && (
          <div className="fixed top-24 left-1/2 -translate-x-1/2 bg-green-600 text-white px-8 py-4 rounded-full shadow-lg z-50">
            <span className="text-lg font-semibold">✓ Added to your stack!</span>
          </div>
        )}
        ...
        <>
          ...
          <div className="fixed inset-x-4 top-20 bottom-20 md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-2xl z-50 overflow-hidden">
            <div className="h-full bg-white rounded-2xl shadow-2xl overflow-y-auto">
              {/* Header */}
              <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-5 flex items-center justify-between">
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                  ...
                  <p className="text-gray-900 leading-relaxed text-lg font-medium mb-3">
                  ...
                  <div className="flex items-start gap-2 text-sm text-gray-700">
                    ...
                    <span>Always start at the lower end if you're new to peptides</span>
                  </div>
                </div>
                ...
                <div className="pt-6 space-y-3">
                  ...
                  <Button
                    onClick={() => setSelectedPeptide(null)}
                    variant="outline"
                    className="w-full border-2 border-gray-300 text-gray-700 hover:bg-gray-50 font-medium py-4 rounded-xl text-lg"
                  >
                    Close
                  </Button>
                </div>
